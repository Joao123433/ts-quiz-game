...
const divScore: HTMLElement = document.querySelector("#div-score")

const form: HTMLElement = document.querySelector("form")
const container: HTMLElement = document.querySelector("#container")
const span: NodeListOf<HTMLElement> = document.querySelectorAll("#numbers-question")
...
function removeEvent() {
  const divs: NodeListOf<HTMLElement> = document.querySelectorAll(".divs")
  divs.forEach(e => {
...
function setScore() {
  const scores: NodeListOf<HTMLElement> = document.querySelectorAll("#scores")
...
function next(ev: { preventDefault: () => void }) {
  ev.preventDefault()
...
function sortQuestions(questions, maxQuestions: number) {
...
function createDiv(value: string) {
